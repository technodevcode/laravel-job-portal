	...
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<a class="btn btn-outline-primary me-2" href="{{ route('admin.dashboard') }}" type="submit">Admin Dashbord</a>
				@endif
...
<div class="container">
    <p class="text-center text-white pt-3 fw-bold fs-6">© 2023 job portal company, all right reserved</p>
</div>
</footer> 
...
<script>
	jQuery('.trumbowyg-editor').trumbowyg();
	jQuery.ajaxSetup({
		headers: {
