                            ...
                            <table class="table ">
                                ...
                                <tbody class="border-0">
                                    @if ($savedJobs->isNotEmpty())
                                        ...
                                        <tr class="active">
                                            <td>
                                                <div class="job-name fw-500">{{ $savedJob->job->job_title }}</div>
                                            ...
                                            <td>
                                                <div class="action-dots ">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li><a class="dropdown-item" href="{{ route("jobDetialPage",$savedJob->job_id) }}"> <i class="fa fa-eye" aria-hidden="true"></i> View</a></li>
